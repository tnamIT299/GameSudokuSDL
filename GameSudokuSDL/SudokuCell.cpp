...
void Sudoku::Cell::setNumber(const int number) // SET So Tu BÀN PHÍM ( So 0 KO ÐUoC NHaP VÀO TRONG BaNG )
{
	if (number == 0)
	{
		mCharNumber = ' ';
...
char Sudoku::Cell::getNumber() const // SETTER/GETTER CuA NUMBER
{
	return mCharNumber;
}
